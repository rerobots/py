...
def add_cli_isready(subparsers):
    ...
    isready_parser = subparsers.add_parser(
        'isready', description=desc, help=desc, add_help=False
    )
    isready_parser.add_argument('ID', nargs='?', default=None, help='instance ID')
    isready_parser.add_argument(
        '--blocking',
        dest='isready_blocking',
        action='store_true',
        default=False,
...
def add_cli_addon_cam(subparsers):
    ...
    addon_cam_parser = subparsers.add_parser(
        'addon-cam', description=desc, help=desc, add_help=False
    )
    addon_cam_parser.add_argument('ID', nargs='?', default=None, help='instance ID')
    addon_cam_parser.add_argument(
        '-f',
        dest='output_file',
...
def add_cli_addon_mistyproxy(subparsers):
    ...
    addon_mistyproxy_parser = subparsers.add_parser(
        'addon-mistyproxy', description=desc, help=desc, add_help=False
    )
    addon_mistyproxy_parser.add_argument(
        'ID', nargs='?', default=None, help='instance ID'
    )
    addon_mistyproxy_parser.add_argument(
        '--http',
        dest='print_addon_mistyproxy_http',
        action='store_true',
        default=False,
    ...
    addon_mistyproxy_parser.add_argument(
        '-h',
        '--help',
        dest='print_addon_mistyproxy_help',
        action='store_true',
        default=False,
        help='print this help message and exit',
    )
...
def add_cli_addon_drive(subparsers):
    ...
    addon_drive_parser = subparsers.add_parser(
        'addon-drive', description=desc, help=desc, add_help=False
    )
    addon_drive_parser.add_argument('ID', nargs='?', default=None, help='instance ID')
    addon_drive_parser.add_argument(
        '-r',
        dest='motion_command',
        metavar='STRING',
        default=None,
...
def add_cli_list(subparsers):
    ...
    list_parser = subparsers.add_parser(
        'list', description=desc, help=desc, add_help=False
    )
    list_parser.add_argument(
        '-h',
        '--help',
        dest='print_list_help',
        action='store_true',
        default=False,
        help='print this help message and exit',
    )
...
def add_cli_search(subparsers):
    ...
    search_parser = subparsers.add_parser(
        'search', description=desc, help=desc, add_help=False
    )
    search_parser.add_argument(
        '-h',
        '--help',
        dest='print_search_help',
        action='store_true',
        default=False,
        help='print this help message and exit',
    )
...
def add_cli_wdinfo(subparsers):
    ...
    wdinfo_parser = subparsers.add_parser(
        'wdinfo', description=desc, help=desc, add_help=False
    )
    wdinfo_parser.add_argument('ID', default=None, help='workspace deployment ID')
    wdinfo_parser.add_argument(
        '-h',
        '--help',
        dest='print_wdinfo_help',
        action='store_true',
        default=False,
        help='print this help message and exit',
    )
...
def add_cli_launch(subparsers):
    ...
    launch_parser = subparsers.add_parser(
        'launch', description=desc, help=desc, add_help=False
    )
    launch_parser.add_argument(
        '-h',
        '--help',
        dest='print_launch_help',
        action='store_true',
        default=False,
        help='print this help message and exit',
    )
    launch_parser.add_argument(
        'ID', nargs='?', default=None, help='workspace type or deployment ID'
    )
    launch_parser.add_argument(
        '--secret-key',
        metavar='FILE',
    ...
    launch_parser.add_argument(
        ...
        default=False,
        help=(
            'assume "yes" for any questions required to launch instance; '
    ...
    launch_parser.add_argument(
        ...
        default=False,
        help=(
            'assume "no" for any questions required to launch instance; '
...
def add_cli_terminate(subparsers):
    ...
    terminate_parser = subparsers.add_parser(
        'terminate', description=desc, help=desc, add_help=False
    )
    terminate_parser.add_argument(
        '-h',
        '--help',
        dest='print_terminate_help',
        action='store_true',
        default=False,
        help='print this help message and exit',
    )
...
def add_cli_list_ci_projects(subparsers):
    ...
    ci_list_proj_parser = subparsers.add_parser(
        'list-ci-projects', description=desc, help=desc, add_help=False
    )
    ci_list_proj_parser.add_argument(
        '-h',
        '--help',
        dest='print_list_ci_projects_help',
        action='store_true',
        default=False,
        help='print this help message and exit',
    )
...
def add_cli_create_ci_project(subparsers):
    ...
    ci_create_proj_parser = subparsers.add_parser(
        'create-ci-project', description=desc, help=desc, add_help=False
    )
    ci_create_proj_parser.add_argument(
        '--repo-url',
        metavar='URL',
        dest='repo_url',
        default=None,
    ...
    ci_create_proj_parser.add_argument(
        '-h',
        '--help',
        dest='print_create_ci_project_help',
        action='store_true',
        default=False,
        help='print this help message and exit',
    )
...
def add_cli_submit_ci_job(subparsers):
    ...
    ci_submit_job_parser = subparsers.add_parser(
        'submit-ci-job', description=desc, help=desc, add_help=False
    )
    ci_submit_job_parser.add_argument(
        '--repo-branch',
        metavar='BRANCH',
        dest='repo_branch',
        default=None,
...
def create_parser(argv=None):
    ...
    argparser = argparse.ArgumentParser(
        description='rerobots API command-line client', add_help=False
    )
    ...
    argparser.add_argument(
        ...
        default=None,
        help=(
            'plaintext file containing API token; with this flag, '
...
def get_random_available_wd(apic):
    ...
    if len(available_wdeployments) == 1:
        ...
        wdeployment_id = available_wdeployments[
            random.randint(0, len(available_wdeployments) - 1)
        ]
...
def cli_launch(apic, args):
    ...
    if args.publickeypath:
        ...
        publickey = None
    if secretkeypath:
        secretkey_fd = open_file_confirm(
            args,
            secretkeypath,
...
def cli_addon_cam(apic, args):
    ...
    while monotonic() - start_time < 120:
        ...
        if payload['status'] == 'active':
            snapshot_payload = apic.get_snapshot_cam(
                instance_id, camera_id=args.camera_id, dformat='jpeg'
            )
...
def main(argv=None):
    ...
    if args.print_help or args.command is None or args.command == 'help':
        if (
            hasattr(args, 'help_target_command')
            and args.help_target_command is not None
        ):
    ...
    try:
        ...
        print(
            'api.rerobots.net server cannot be reached.  Are you connected to the Internet?'
        )
        return 1
